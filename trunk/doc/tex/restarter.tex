...
for periodically calling \code{should_restart}, exiting with code 75 whenever it
returns \class{True} (presumably after cleanly shutting down). Exit code 75
seemed appropriate to use because of its meaning on \UNIX{} systems. From
FreeBSD 6.1-RELEASE, \file{/usr/include/sysexits.h}:
